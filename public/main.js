document.addEventListener("DOMContentLoaded", (e) => {
  ...
  button2 = document.getElementById("GetPhotos");
...
async function GetPhotos() {
  try {
    ...
    await fetch(
      `https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=990356b263d64347b6d710c80a2f1602&text=${inputValue}&format=json&nojsoncallback=1`
    )
      .then((response) => response.text())
      .then((data) => {
        console.log(data);
